...
class AboutObjects < EdgeCase::Koan
  ...
  def test_some_system_objects_always_have_the_same_id
    assert_equal __(false.object_id), false.object_id
    assert_equal __(true.object_id), true.object_id
    assert_equal __(nil.object_id), nil.object_id
  end

  def test_small_integers_have_fixed_ids
    assert_equal __(0.object_id), 0.object_id
    assert_equal __(1.object_id) , 1.object_id
    assert_equal __(2.object_id), 2.object_id
    assert_equal __(100.object_id), 100.object_id
